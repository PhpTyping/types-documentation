...
Make sure the BCMath extension (often `php-bcmath`) is installed and enabled if you'd like FloatObjects to use this
...
Make sure the GMP extension (often `php-gmp`) is installed and enabled if you'd like FloatObjects to use this library
